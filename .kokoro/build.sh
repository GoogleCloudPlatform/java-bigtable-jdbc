...
graalvm)
    ...
    mvn -B ${INTEGRATION_TEST_ARGS} -ntp -Dtest=BigtableDriverIT -Djacoco.skip=true -Pnative test
    RETURN_CODE=$?
    ;;
graalvm17)
    # Run Unit and Integration Tests with Native Image
...
then
    ...
    ${KOKORO_GFILE_DIR}/linux_amd64/flakybot -repo=GoogleCloudPlatform/java-bigtable-jdbc
fi
